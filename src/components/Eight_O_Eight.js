...
export default class Eight_O_Eight extends React.Component {
    ...
    createSampler(handles, potiCount) {
        ...
        handles.forEach((handle, index)=> {
            ...
            sampleMap[handle] = `${BUCKET +handle + "/" + handle}.WAV`;
            ...
            if (potiCount >= 1) {
                ...
                steps.forEach((item, index)=> {
                    ...
                    sampleMap[handle][key] = `${BUCKET+handle + "/" + handle + value}.WAV`;
                    ...
                    if (potiCount >= 2) {
                        ...
                        steps.forEach((item, index)=> {
                            ...
                            sampleMap[handle][key][key2] = `${BUCKET +handle + "/"+ handle + value + value2}.WAV`
                            console.log(sampleMap[handle][key][key2]);
                        });
                    }
                });
            }
